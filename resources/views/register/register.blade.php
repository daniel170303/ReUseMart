...
<body class="bg-white font-sans">
  <div class="flex min-h-screen">
    ...
    <!-- Form Register (posisi kanan) -->
    <div class="w-full md:w-1/2 flex items-center justify-center px-6 lg:px-20">
        <div class="w-full max-w-md">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">Create your account</h2>
            <p class="text-lg text-gray-600 mb-8">Fill in the information to get started</p>

            <form id="registerForm" method="POST" action="{{ route('register') }}" class="space-y-6" onsubmit="return validateForm()">
            @csrf
            <!-- Role -->
                <div>
                    <label class="block text-base font-medium text-gray-700 mb-2">Role</label>
                    <select name="role" id="role" class="w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600" required>
            ...
            <!-- Email -->
                <div>
                    ...
                    <input type="email" name="email" id="email" class="mt-2 block w-full px-4 py-3 text-base border border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600" />
            ...
            <!-- Password -->
                <div>
                    ...
                    <div class="relative mt-2">
                        <input type="password" name="password" id="password" class="block w-full px-4 py-3 text-base border border-gray-300 rounded-md shadow-sm focus:ring-green-600 focus:border-green-600 pr-12" />
