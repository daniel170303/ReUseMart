<!-- resources/views/barang_titipan/create.blade.php -->

@extends('layouts.app')

@section('content')
    <div class="container">
        <h1>Tambah Barang Titipan</h1>

        <form action="{{ route('barang_titipan.store') }}" method="POST">
            @csrf
            <div class="mb-3">
                <label for="nama_barang_titipan" class="form-label">Nama Barang Titipan</label>
                <input type="text" class="form-control" id="nama_barang_titipan" name="nama_barang_titipan" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="garansi_barang" name="garansi_barang" required>
            </div>

            <div class="mb-3">
                <label for="berat_barang" class="form-label">Berat Barang</label>
                <input type="number" class="form-control" id="berat_barang" name="berat_barang" required>
            </div>
