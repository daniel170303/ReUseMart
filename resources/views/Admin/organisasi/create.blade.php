...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add New Organization</h1>
            ...
            <form action="{{ route('admin.organisasi.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nama_organisasi') is-invalid @enderror" 
                               id="nama_organisasi" name="nama_organisasi" value="{{ old('nama_organisasi') }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control @error('email_organisasi') is-invalid @enderror" 
                               id="email_organisasi" name="email_organisasi" value="{{ old('email_organisasi') }}" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nomor_telepon_organisasi') is-invalid @enderror" 
                               id="nomor_telepon_organisasi" name="nomor_telepon_organisasi" value="{{ old('nomor_telepon_organisasi') }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" class="form-control @error('password_organisasi') is-invalid @enderror" 
                               id="password_organisasi" name="password_organisasi" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('alamat_organisasi') is-invalid @enderror" 
                              id="alamat_organisasi" name="alamat_organisasi" rows="3" required>{{ old('alamat_organisasi') }}</textarea>
